                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <div class="col-12">
                                                ...
                                                <img src="{{ asset('storage/admins/images/' . $blogPost->image) }}" class="product-image" alt="Product Image">
                                            </div>

                                            <div class="col-12 product-image-thumbs multiple-items">
                                                <div class="product-image-thumb active">
                                                    <img src="{{ asset('storage/admins/images/' . $blogPost->image) }}" alt="Product Image">
                                                </div>

                                                @foreach ($blogPost->images as $img)
                                                <div class="product-image-thumb">
                                                    <img src="{{ asset('storage/admins/images/' . $img->image) }}" alt="Product Image">
                                                </div>
                                                @endforeach
