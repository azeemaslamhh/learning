                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Add Question Information</h3>
                            </div>

                            <form method="POST" action="{{ route('problem_lists.store') }}">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="problem" type="text" class="form-control @error('problem') is-invalid @enderror" name="problem" value="{{ old('problem') }}" required autocomplete="name" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="anwser" type="text" class="form-control @error('anwser') is-invalid @enderror" rows="8" name="anwser" value="{{ old('anwser') }}" required autocomplete="anwser" autofocus></textarea>
                                        @error('anwser')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="likes" type="number" class="form-control @error('likes') is-invalid @enderror" name="likes" value=0 required autocomplete="likes" autofocus>
                                        @error('likes')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="disLikes" type="number" class="form-control @error('disLikes') is-invalid @enderror" name="disLikes" value=0 required autocomplete="disLikes" autofocus>
                                        @error('disLikes')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="filename" type="text" class="form-control @error('filename') is-invalid @enderror" name="filename" value="{{ old('filename') }}" required autocomplete="filename" autofocus>
